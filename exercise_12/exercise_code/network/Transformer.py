...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.embedding = Embedding(self.vocab_size, self.d_model, self.max_length, dropout=self.dropout)
        self.encoder = Encoder(**self.hparams)
        self.decoder = Decoder(**self.hparams)
        self.output_layer = torch.nn.Linear(self.d_model, self.vocab_size, bias=False)
    ...
    def forward(self,
        ...
        # Compute the forward pass through the encoder and mask
        ...
        # Pass on the encoder and decoder padding masks
        decoder_output = self.decoder(decoder_embedding, encoder_output, decoder_mask, encoder_mask) 
